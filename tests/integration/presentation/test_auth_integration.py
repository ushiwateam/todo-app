...
def test_register_duplicate_email(client, create_user):
    ...
    response = client.post(
        "/register",
        json={"name": "user", "email": "test@example.com", "password": "dummypassword"},
    )
...
def test_login_user(client, create_user):
    user_data = {"email": "test@example.com", "password": "dummypassword"}
...
def test_login_bad_password(client, create_user):
    user_data = {"email": "test@example.com", "password": "badpassword"}
