...
from app.todos.business.interface import _UNSET, ITodoService


class TodoService(ITodoService):
    def add_todo(self, title: str, description: str | None = None):
        todo_entity = Todo(title=title, description=description, user_id=self.user.id)
    ...
    def get_todos(self, page, limit):
        ...
        return {"data": data, "page": page, "limit": limit, "total": total_todos}
